...
print(manager.influencer_campaign_report("AliceJohnson"))
print(manager.influencer_campaign_report("OliviaBennett"))
print(manager.influencer_campaign_report("DanielRodriguez"))


print(manager.participate_in_campaign("OliviaBennett", 2))
print(manager.influencer_campaign_report("OliviaBennett"))
